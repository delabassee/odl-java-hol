...
public final class SpeakerRepository {
    ...
    public List<Speaker> getByLastName(String name) {
        List<Speaker> matchList = speakers.stream().filter((e) -> (e.lastName().toLowerCase().contains(name.toLowerCase())))
    ...
    public List<Speaker> getByTrack(Track track) {
        ...
        List<Speaker> matchList = speakers.stream().filter((e) -> (e.track() == track))
                .collect(Collectors.toList());
    ...
    public List<Speaker> getByCompany(String company) {
        ...
        List<Speaker> matchList = speakers.stream()
                .filter((e) -> (e.company().toLowerCase().contains(company.toLowerCase())))
                .collect(Collectors.toList());
